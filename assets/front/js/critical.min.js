...
const cookieBox = document.querySelector(".wrapper-sm1"),
    acceptBtn = cookieBox.querySelector(".button-sm1");

//const cookieBoxOpen = document.querySelector(".blob-sm1"),
//     acceptBtnOpen = cookieBoxOpen.querySelector(".blob-sm1-img");

acceptBtn.onclick = ()=>{
    //setting cookie for 1 month, after one month it'll be expired automatically
    document.cookie = "LayCookie=hidden; max-age="+60*60*24*30;
    if(document.cookie){ //if cookie is set
        cookieBox.classList.add("hide"); //hide cookie box
        //cookieBoxOpen.classList.remove("hide")
...
//acceptBtnOpen.onclick = ()=>{
//     cookieBox.classList.remove("hide");
//     cookieBoxOpen.classList.add("hide")
// }

let checkCookie = document.cookie.indexOf("LayCookie=hidden"); //checking our cookie
...
console.big.bold.red.log("Ce site est soumis au droit d'auteur, toute copie, reproduction partielle ou totale est susceptible d'entraîner des poursuites judiciaires")
console.big.bold.blue.log("                __")
console.big.bold.blue.log("     .,-;-;-,. /'_\\")
console.big.bold.blue.log("   _/_/_/_|_\\_\\) /")
console.big.bold.blue.log(" '-<_><_><_><_>=/\\")
console.big.bold.blue.log("   `/_/====/_/-'\\_\\")
console.big.bold.blue.log("    \"\"     \"\"    \"\"")
...
function closePopup() {
    ...
    removeClass(e, "animate"), addClass(e, "no-animate"), removeClass(t, "open"), isPopupOpen = !1, localStorage.setItem("fobi-pop-up-open", "false")
}
