  ...
  NioApp.DataTable = function (elm, opt) {
    if ($(elm).exists()) {
      $(elm).each(function () {
        ...
        var dom_normal = '<"row justify-between g-2"<"col-12 col-sm-12 text-left"f><"col-12 col-sm-12 display_none text-right"<"datatable-filter"l>>><"datatable-wrap my-3"t><"row align-items-center"<"col-12 col-sm-12 col-md-12"p><"col-12 col-sm-12 col-md-12 text-left text-md-right"i>>';
        var dom_separate = '<"row justify-between g-2"<"col-12 col-sm-12text-left"f><"col-12 col-sm-12 display_none text-right"<"datatable-filter"l>>><"my-3"t><"row align-items-center"<"col-12 col-sm-12 col-md-12"p><"col-12 col-sm-12 col-md-12 text-left text-md-right"i>>';
